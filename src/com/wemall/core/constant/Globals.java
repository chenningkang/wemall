...
public class Globals {
    public static final String DEFAULT_SYSTEM_TITLE = "壹点零商城V3.0";
    public static final boolean SSO_SIGN = true;
    public static final String DEFAULT_SHOP_VERSION = "201706-ver3.0";
    public static final String DEFAULT_SHOP_OUT_VERSION = "V3.0";
    public static final String DEFAULT_WBESITE_NAME = "壹点零商城";
